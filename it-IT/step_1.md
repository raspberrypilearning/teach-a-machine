...
![L'immagine mostra un'interfaccia di apprendimento automatico di "Teachable Machine" in cui un modello viene addestrato a riconoscere i gesti delle mani che rappresentano i numeri "cinque" e "tre". Sulla destra, nella sezione "Anteprima", il feed della webcam mostra una mano con tre dita. Sotto, nella sezione "Output", vengono mostrati i risultati della classificazione: il modello prevede una probabilità del 94% per "tre" e una probabilità del 6% per "cinque". Il modello ha identificato correttamente il gesto della mano come "tre."](images/wywm.png)
