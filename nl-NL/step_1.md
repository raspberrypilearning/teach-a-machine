...
![De afbeelding toont een machine learning interface van "Teachable Machine" waarbij een model wordt getraind om handgebaren te herkennen voor de getallen "Vijf" en "Drie." Aan de rechterkant, in het "Voorbeeld bekijken"-gedeelte, toont de webcamfeed een hand met drie vingers. Daaronder worden in het gedeelte 'Uitvoer' de classificatieresultaten weergegeven, waarbij het model een waarschijnlijkheid van 94% voor 'Drie' en een kleine waarschijnlijkheid van 6% voor 'Vijf' voorspelt Het model heeft het handgebaar succesvol geïdentificeerd als "Drie."](images/wywm.png)
